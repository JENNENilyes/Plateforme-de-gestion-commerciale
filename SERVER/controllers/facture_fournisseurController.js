...
module.exports.readFactureF = async (req, res) => {
        ...
        const factListe = await Facture_fournisseurModel.find(filter).populate('fournisseur').populate('LigneAchat');
...
module.exports.readFactureFI = async (req, res) => {
    const factF = await facture_fournisseurModel.findById(req.params.id).populate('fournisseur').populate('LigneAchat');
...
module.exports.createFactureF  =  async (req, res) => {
    ...
    let newRecord = new facture_fournisseurModel({
        ...
        LigneAchat: req.body.LigneAchat,
